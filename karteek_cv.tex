...
\begin{document}
   ...
   \section{Patents \& Publications}
        ...
        \begin{twocolentry}{
            \href{https://arxiv.org/abs/2606.29783}{IROS 2026 | arXiv:2606.29783}
        }
            \textbf{FalconTrack: Photorealistic Auto-Labeled Perception and Physics-Aware Vision-Based Aerial Tracking}\end{twocolentry}

        \vspace{0.05 cm}
        \begin{onecolentry}
            Yan Miao, \textbf{Karteek Gandiboyina}, Noah Giles, Hideki Okamoto, Bardh Hoxha, Georgios Fainekos, Sayan Mitra
            \begin{highlights}
